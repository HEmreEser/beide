...
class _LoginPageState extends State<LoginPage> {
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(60), // Increased from 30 to maintain proportion
                  ),
                  child: Image.asset(
  ...
  void _handleAuth() async {
    ...
    if (_isRegistering && _fullNameController.text.trim().isEmpty) {
      _showAlert('Fehler', 'Name ist erforderlich');
      return;
    }

    if (_passwordController.text.length < 6) {
      _showAlert('Fehler', 'Passwort muss mindestens 6 Zeichen lang sein');
      return;
    }
